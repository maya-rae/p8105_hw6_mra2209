...
I will summarize the results in this ggplot. I am confused as to why I
cannot compute the RMSE for my stepwise and interactions models using
this workflow. I tried to exclude Na values and align the factor levels,
but nothing worked. I can only see the main_effects data in my plot
below.
...
I will use ridge regression cross-validation to compare the three models
...
My stepwise model has the lowest RMSE value of 272, meaning, on average,
the predictions are off by about 272 grams from the true birthweight.
Out of these models, the stepwise one has the best predictive accuracy.
It is also the model with the highest adjusted R squared value.
